...
if ( ! function_exists('array_push_multidimension'))
{
     ...
     * @return array
     */
    function array_push_multidimension(array $array_data = array(), array $array_push = array(), string $position = 'last')
    {
        $array = array();
        if(is_array($array_data))
        {
            if($position == 'last')
            {
                $array = array_keys($array_data);
                $position_key = @end($array);
            }
            else
            {
